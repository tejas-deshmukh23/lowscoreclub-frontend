...
//                 Log in
//               </a>
//               <a href="/signup" style={{backgroundColor:"#6039D2"}} className="px-3 py-1.5 text-sm text-white hover:bg-blue-600 rounded-md">
//                 Sign up
//               </a>
//             </div>
//           </div>
...
//             <a href="/" className="block px-3 py-2 text-base hover:bg-gray-100 rounded-md">Home</a>
            
//             <a href="/login" style={{color:"#6039D2"}} className="block px-3 py-2 text-base hover:bg-gray-100 rounded-md">Log in</a>
//             <a href="/signup" style={{backgroundColor:"#6039D2"}} className="block px-3 py-2 text-base  hover:bg-gray-100 rounded-md">Sign up</a>
//           </div>
//         </div>
//       )}
//     </nav>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-b border-gray-300">
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="/login" style={{color:"#6039D2"}} className="block px-3 py-2 text-base hover:bg-gray-100 rounded-md">Log in</a>
            <a href="/signup" style={{backgroundColor:"#6039D2", color: "white"}} className="block px-3 py-2 text-base text-white rounded-md">Sign up</a>
          </div>
        </div>
      )}
    </nav>
